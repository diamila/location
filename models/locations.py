...
class Location(models.Model):
    ...
    prixlocation_id = fields.Float(string="Prix de la location (hors charges en fcfa)",
                                   related='bien_loue.prix_location', default=0.0,
    ...
    # champs----locataire
    locataires = fields.Many2one('lb.locataire', ondelete='cascade', string="Locataire", required=True)
    ...
    #
    loyer_sans_charges = fields.Float(string="Prix de la location en fcfa", related='bien_loue.prix_location', default=0.0, digits=dp.get_precision('Loyer hors charges'), required=True)
